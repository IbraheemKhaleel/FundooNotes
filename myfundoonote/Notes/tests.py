...
class Data(APITestCase):
    def setUp(self):
        ...
        self.note_get_post_url = reverse('note_create_retrieve')
        self.note_put_delete_url = reverse('note_update_delete', args=[1])
        ...
        self.invalid_note_data = {'user': "sadas@gmail.com",
                                  'description': "Need a change",
                                  'labels': "Third Note",
                                  'collaborators': [1],
                                  }
...
class NotesTest(Data):
    def test_given_valid_note_url_for_crud(self):
        ...
        print(life)
        print(self.valid_registration_data)
